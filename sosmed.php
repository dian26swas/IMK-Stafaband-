...
<h1 style="color:white">ARTIST</h1>
	<div class="row">
		...
		<div class="column">
			<a class="klik_menu" id="lagu">
				<div class="container">
					<img src="img/bts.png" alt="bts" class="image" style="width:100%">
					<h5> BTS </h5>
					<div class="middle">
						<img src="img/play-button.png" alt="Bitterlove" class="text">
					</div>
		...
		<div class="column">
			<a class="klik_menu" id="lagu">
				<div class="container">
					<img src="img/colde.jpg" alt="Bitterlove" class="image" style="width:100%">
					<h5> Colde </h5>
					<div class="middle">
						<img src="img/play-button.png" alt="Bitterlove" class="text">
					</div>
